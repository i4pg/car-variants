...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { car_id: @variant.car_id, color: @variant.color, model: @variant.model } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { car_id: @variant.car_id, color: @variant.color, model: @variant.model } }
